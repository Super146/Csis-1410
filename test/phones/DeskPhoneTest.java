...
class DeskPhoneTest {
	...
	void setUp() throws Exception {
		pushButtonPhone = new PushButtomPhone(
	...
	void plugIn_connectPhone() {
		...
		assertTrue(pushButtonPhone.isConneted());
		
		rotaryPhone.plugIn();
		assertTrue(rotaryPhone.isConneted());
	}

	@Test
	void unplug_disconnectPhone() {
		pushButtonPhone.unplug();
		assertFalse(pushButtonPhone.isConneted());
		
		rotaryPhone.unplug();
		assertFalse(rotaryPhone.isConneted());
	}
