...
import DemoWrapper.DemoWrapperClass;
/**
...
assertEquals("h lowercase letter",
DemoWrapperClass.charProperties('h'));
}
@Test
void charProperties_uppercase_markedUppercase() {
assertEquals("F uppercase letter",
DemoWrapperClass.charProperties('F'));
}
@Test
